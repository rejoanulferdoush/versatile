    ...
    <!-- banner right -->
     <div class="banner__right">
      ...
      <div class="tutorial">
        ...
        <div class="right__tutorial">
          <h4 class="section__text--xl">350+</h4>
          <p class="primary__text">Video Tutorial</p>
        </div>
      </div>
      <div class="workout">
          <h4 class="section__text--xl">500+</h4>
          <p class="primary__text">Free Workout videos</p>
      </div>
     </div>
  </div>
</header>
